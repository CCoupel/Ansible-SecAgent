...
func TestPluginAuthUnknownToken(t *testing.T) {
	...
	req := pluginReq("POST", "/api/exec/host", "secagent_plg_does_not_exist")
	req.RemoteAddr = "10.0.0.1:80"
	w := httptest.NewRecorder()
	_, ok := requirePluginAuth(w, req)
	if ok {
...
func TestPluginAuthIPMultipleCIDRs(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_cidr_multi_01"
...
func TestPluginAuthIPOutsideCIDR(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_cidr_deny_01"
...
func TestPluginAuthIPNoRestriction(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_cidr_none_01"
...
func TestPluginAuthHostnameMismatch(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_host_deny_01"
...
func TestPluginAuthHostnameAnchoredNoPartial(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_host_anchor_01"
...
func TestPluginAuthHostnameNoRestriction(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_host_none_01"
...
func TestPluginAuthCIDRPassHostnameFail(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_cidr_ok_host_fail_01"
...
func TestPluginAuthHostnamePassCIDRFail(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_host_ok_cidr_fail_01"
...
func TestExecCommandWithValidPluginToken(t *testing.T) {
	s := newTestStore(t)
	SetAdminStore(s)
	plain := "secagent_plg_exec_e2e_01"
...
func TestPluginTokenPrefixRelay_plg(t *testing.T) {
	...
	if len(plain) < 13 || plain[:13] != "secagent_plg_" {
		t.Errorf("expected secagent_plg_ prefix, got %q", plain)
	}
...
func TestPluginTokenHashConsistency(t *testing.T) {
	plain := "secagent_plg_hash_test_abc123"
