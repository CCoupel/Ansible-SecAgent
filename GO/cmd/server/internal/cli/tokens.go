...
Examples:
  relay-server tokens create --role enrollment --hostname-pattern "vp.*" --reusable --expires 30d
  relay-server tokens create --role plugin --description "Terraform" --allowed-ips "10.0.0.0/8" --expires 24h`,
